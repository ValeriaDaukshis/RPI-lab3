...
function encodeToRot13(str) {
	...
	for(i = 0 ; i < str.length ; ++i)
	{
		if(str.charCodeAt(i) <= 90 && str.charCodeAt(i) >=65) 
            ...
            newstr += String.fromCharCode((str.charCodeAt(i)-97 + 13)%26 +97); 
		else
			newstr += str.charAt(i);
	}
	return newstr;
...
function getCardId(value) {
	 ...
	 {
		 //чирва 26-38
		 case '♥': return (getNumber(value ) + 26) 
			
	     //буба 13-25
		 case '♦': return(getNumber(value ) + 13); 
		 
		 //крести 0-12
		 case '♣': return(getNumber(value));  
		 
		 //пика 39-51
		 case '♠': return(getNumber(value) + 39);
	 }
}
